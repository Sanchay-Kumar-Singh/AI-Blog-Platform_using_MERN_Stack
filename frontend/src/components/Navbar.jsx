  ...
  return (
    <nav className="bg-white px-6 md:px-12 lg:px-24 py-4 flex items-center justify-between relative shadow-sm">
      ...
      <div className="hidden md:flex  items-center bg-zinc-50 border border-zinc-200 rounded-full px-1 py-1 gap-2">
        <Link
          to="/"
          className="px-4 py-2 rounded-full text-sm text-zinc-900 hover:text-zinc-800 transition"
        >
          Home
        </Link>
        ...
        {user && (
          <>
            <Link
              to="/dashboard"
              className="px-4 py-2 rounded-full text-sm text-zinc-5=900 hover:text-zinc-800 transition"
            >
              Dashboard
            </Link>
