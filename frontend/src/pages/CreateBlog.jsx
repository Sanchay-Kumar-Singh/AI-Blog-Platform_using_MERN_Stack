...
const inputCls =
  'w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-indigo-500 transition bg-white'
...
const CreateBlog = () => {
  ...
  const handleGenerate = async () => {
    ...
    if (!aiTopic.trim()) {
      ...
      setError('Enter a topic to generate')
      return
    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-200 rounded-xl p-6 mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="bg-indigo-600 text-white px-6 py-2.5 rounded-lg text-sm font-bold hover:bg-indigo-700 disabled:opacity-50 transition whitespace-nowrap"
      ...
      >
...

        {
          isAIGenerated && (
            ...
            <p className="text-indigo-600 text-sm font-semibold">
              ✦ This content was generated by Gemini AI
            </p>
        ...
        <button
          ...
          className="bg-indigo-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-indigo-700 disabled:opacity-50 transition self-start"
